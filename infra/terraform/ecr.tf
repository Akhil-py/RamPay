# ---------------------------------------------------------------------------
# ECR — payment-service repository
# ---------------------------------------------------------------------------
...
resource "aws_ecr_lifecycle_policy" "fraud_service" {
  repository = aws_ecr_repository.fraud_service.name
